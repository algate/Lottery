<template>
	<view @touchmove.stop.prevent>
		...
		<view @touchmove.stop="tapEvent"><canvas style="width: 100vw;height: 100vh;" type="2d" canvas-id="move-effect" id="move-effect"></canvas></view>
	</view>
</template>
<script>
class Particle {
	...
	methods: {
		...
		updateParticles() {
			...
			for (let i = this.particles.length - 1; i >= 0; i--) {
				if (this.particles[i].position.y > this.canvas.height || this.particles[i].alpha <= 0 || this.particles[i].fontSize <= 0) {
